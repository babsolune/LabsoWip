...
class ModlistDisplayCategoryController extends ModuleController
{
	...
	private function build_items_listing_view(Date $now, $field, $sort_mode, $page)
	{
		...
		$pagination = $this->get_pagination($condition, $parameters, $field, $sort_mode, $page);
	...
	private function build_sorting_form($field, $mode)
	{
		...
		if ($this->comments_config->are_comments_enabled())
			$sort_options[] = new FormFieldSelectChoiceOption($common_lang['sort_by.number_comments'], Itemlist::SORT_FIELDS_URL_VALUES[Itemlist::SORT_NUMBER_COMMENTS]);

		if ($this->notation_config->is_notation_enabled())
			$sort_options[] = new FormFieldSelectChoiceOption($common_lang['sort_by.best_note'], Itemlist::SORT_FIELDS_URL_VALUES[Itemlist::SORT_NOTATION]);
