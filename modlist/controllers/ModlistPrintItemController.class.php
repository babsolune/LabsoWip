...
class ModlistPrintItemController extends ModuleController
{
	...
	private function check_authorizations()
	{
		...
		$not_authorized = !ModlistAuthorizationsService::check_authorizations($itemlist->get_id_category())->write() && (!ModlistAuthorizationsService::check_authorizations($itemlist->get_id_category())->moderation() && $itemlist->get_author_user()->get_id() != AppContext::get_current_user()->get_id());
