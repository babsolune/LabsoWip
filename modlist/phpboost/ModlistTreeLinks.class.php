...
class ModlistTreeLinks implements ModuleTreeLinksExtensionPoint
{
	public function get_actions_tree_links()
	{
		...
		$manage_categories_link->add_sub_link(new ModuleLink(LangLoader::get_message('category.add', 'categories-common'), ModlistUrlBuilder::add_category(AppContext::get_request()->get_getint('id_category', Category::ROOT_CATEGORY)), ModlistAuthorizationsService::check_authorizations()->manage_categories()));
		...
		$manage_modlist_link->add_sub_link(new ModuleLink($lang['modlist.add'], ModlistUrlBuilder::add_item(AppContext::get_request()->get_getint('id_category', Category::ROOT_CATEGORY)), ModlistAuthorizationsService::check_authorizations()->moderation()));
		...
		{
			$tree->add_link(new ModuleLink($lang['modlist.add'], ModlistUrlBuilder::add_item(AppContext::get_request()->get_getint('id_category', Category::ROOT_CATEGORY)), ModlistAuthorizationsService::check_authorizations()->write() || ModlistAuthorizationsService::check_authorizations()->contribution()));
		}
