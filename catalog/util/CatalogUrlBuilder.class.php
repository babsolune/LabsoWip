...
class CatalogUrlBuilder
{
	...
	private static $dispatcher = '/catalog';
	 ...
	 * @return Url
	 */
	public static function download_product_link($id)
	{
		return DispatchManager::get_url(self::$dispatcher, '/product/' . $id);
	}
     ...
     * @return Url
     */
    public static function gcs_manage()
    {
        return DispatchManager::get_url(self::$dispatcher, '/admin/gcs/');
    }
    ...
    {
        return DispatchManager::get_url(self::$dispatcher, '/gcs/');
    }
