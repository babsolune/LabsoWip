<section id="module-catalog">
	...
	<div class="content">
		...
		# ENDIF #
		<article itemscope="itemscope" itemtype="http://schema.org/CreativeWork" id="article-catalog-{ID}" class="article-catalog# IF C_NEW_CONTENT # new-content# ENDIF #">
			<header>
				<h2>
			...
			<div class="content">
				<div class="options infos">
					<div class="center">
						...
						# ENDIF #
						# IF C_IS_DOWNLOADABLE #
							# IF C_VISIBLE #
								# IF C_DISPLAY_PRODUCT #
							...
							<span class="text-strong">{@downloads_number} : </span><span>{NUMBER_DOWNLOADS}</span>
						# ENDIF #
					</div>
					<h6>{@product_infos}</h6>
						<p>{PRICE} {PRICE_UNIT}</p>
					...
					# IF C_NB_VIEW_ENABLED #<span class="text-strong">{@product.number.view} : </span><span>{NUMBER_VIEW}</span># ENDIF #<br />
...
<script src="{PATH_TO_ROOT}/catalog/templates/js/jQuery.Brazzers-Carousel.min.js"></script>

<script>

	$(document).ready(function() {
		$(".catalog-carousel").brazzersCarousel();
	});
