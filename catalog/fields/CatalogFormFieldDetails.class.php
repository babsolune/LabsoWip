<?php
/*##################################################
 *		      CatalogFormFieldDetails.class.php
 *                            -------------------
 *   begin                : April 15, 2016
...
class CatalogFormFieldDetails extends AbstractFormField
{
	...
	function display()
	{
		...
		$tpl = new FileTemplate('catalog/fields/CatalogFormFieldDetails.tpl');
