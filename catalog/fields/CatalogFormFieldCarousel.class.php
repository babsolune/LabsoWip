<?php
/*##################################################
 *		      CatalogFormFieldCarousel.class.php
 *                            -------------------
 *   begin                : April 15, 2016
...
class CatalogFormFieldCarousel extends AbstractFormField
{
	...
	function display()
	{
		...
		$tpl = new FileTemplate('catalog/fields/CatalogFormFieldCarousel.tpl');
