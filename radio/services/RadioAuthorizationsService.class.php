<?php
/*##################################################
 *		                RadioAuthorizationsService.class.php
 *                            -------------------
 *   begin                : May, 02, 2017
...
class RadioAuthorizationsService
{
	public $id_category;
	...
	{
		$auth = RadioService::get_categories_manager()->get_heritated_authorizations($this->id_category, $bit, $mode);
