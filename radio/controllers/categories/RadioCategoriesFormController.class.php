<?php
/*##################################################
 *		                RadioCategoriesFormController.class.php
 *                            -------------------
 *   begin                : May, 02, 2017
...
class RadioCategoriesFormController extends AbstractRichCategoriesFormController
{
	...
	{
		return RadioUrlBuilder::add_category(AppContext::get_request()->get_getint('id_parent', 0));
	}
