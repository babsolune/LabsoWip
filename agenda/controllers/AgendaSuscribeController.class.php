<?php
/*##################################################
 *                      AgendaSuscribeController.class.php
 *                            -------------------
...
class AgendaSuscribeController extends ModuleController
{
	private $event;
	...
	public function execute(HTTPRequestCustom $request)
	{
		...
		if (!empty($event_id))
		{
			...
			{
				AgendaService::add_participant($event_id, $current_user_id);
	...
	private function check_authorizations()
	{
		...
		{
			$error_controller = new UserErrorController(LangLoader::get_message('error', 'status-messages-common'), LangLoader::get_message('agenda.notice.suscribe.event_date_expired', 'common', 'agenda'));
			DispatchManager::redirect($error_controller);
		}
