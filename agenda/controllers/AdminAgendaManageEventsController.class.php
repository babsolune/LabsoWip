<?php
/*##################################################
 *		    AdminAgendaManageEventsController.class.php
 *                            -------------------
 *   begin                : July 25, 2013
 ...
 */
class AdminAgendaManageEventsController extends AdminModuleController
{
	private $lang;
	private $view;
	...
	public function execute(HTTPRequestCustom $request)
	{
		...
		return new AdminAgendaDisplayResponse($this->view, $this->lang['agenda.config.events.management']);
	}
