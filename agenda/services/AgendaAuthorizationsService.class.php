<?php
/*##################################################
 *                              AgendaAuthorizationsService.class.php
 *                            -------------------
...
class AgendaAuthorizationsService
{
	public $id_category;
	...
	{
		$auth = AgendaService::get_categories_manager()->get_heritated_authorizations($this->id_category, $bit, $mode);
