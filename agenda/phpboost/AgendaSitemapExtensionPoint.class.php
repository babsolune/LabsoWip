<?php
/*##################################################
 *		             AgendaSitemapExtensionPoint.class.php
 *                            -------------------
...
class AgendaSitemapExtensionPoint extends SitemapCategoriesModule
{
	public function __construct()
	{
		parent::__construct(AgendaService::get_categories_manager());
	}
