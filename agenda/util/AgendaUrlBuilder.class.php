 ...
 * @desc Url builder of the agenda module
 */
class AgendaUrlBuilder
{
	const DEFAULT_SORT_FIELD = 'date';
	const DEFAULT_SORT_MODE = 'desc';

	private static $dispatcher = '/agenda';
	 ...
	 * @return Url
	 */
	public static function ajax_month_agenda()
	{
		return DispatchManager::get_url(self::$dispatcher, '/ajax_month_agenda/');
	}
	 ...
	 * @return Url
	 */
	public static function home($year = null, $month = null, $day = null, $agenda_anchor = false)
	{
		$year = $year !== null ? $year . '/' : '';
		$month = $month !== null ? $month . '/' : '';
		$day = $day !== null ? $day . '/' : '';
		$agenda_anchor = $agenda_anchor !== false ? '#agenda' : '';
		return DispatchManager::get_url(self::$dispatcher, '/' . $year . $month . $day . $agenda_anchor);
	}
}
?>
