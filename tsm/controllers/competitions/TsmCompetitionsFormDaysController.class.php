<?php
/*##################################################
 *                   TsmCompetitionsFormDaysController.class.php
 *                            -------------------
...
class TsmCompetitionsFormDaysController extends AdminModuleController
{
	private $lang,
            $tsm_lang,
            $form,
	...
	private function build_form(HTTPRequestCustom $request)
	{
		...
		$fieldset = new FormFieldsetHTML('days_management', $this->lang['tools.days.manager']);
	...
	private function generate_response(View $view)
	{
        ...
        $graphical_environment->set_page_title($this->lang['tools.days.manager']);
		$graphical_environment->get_seo_meta_data()->set_description($this->lang['competition.edit'], $this->lang['competitions.competition']);
		$graphical_environment->get_seo_meta_data()->set_canonical_url(TsmUrlBuilder::edit_competition_days($competition->get_id()));
		...
		$breadcrumb->add($this->lang['tools.days.manager']);
