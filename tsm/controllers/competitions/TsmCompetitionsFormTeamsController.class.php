<?php
/*##################################################
 *                   TsmCompetitionsFormTeamsController.class.php
 *                            -------------------
...
class TsmCompetitionsFormTeamsController extends AdminModuleController
{
	private $lang,
            $tsm_lang,
            $form,
	...
	private function build_form(HTTPRequestCustom $request)
	{
		...
		$fieldset = new FormFieldsetHTML('teams_management', $this->lang['tools.teams.manager']);
	...
	private function generate_response(View $view)
	{
        ...
        $graphical_environment->set_page_title($this->lang['tools.teams.manager']);
		$graphical_environment->get_seo_meta_data()->set_description($this->lang['competition.edit'], $this->lang['competitions.competition']);
		$graphical_environment->get_seo_meta_data()->set_canonical_url(TsmUrlBuilder::edit_competition_teams($competition->get_id()));
		...
		$breadcrumb->add($this->lang['tools.teams.manager']);
