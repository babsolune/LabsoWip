<?php
/*##################################################
 *                   TsmSeasonsAuthService.class.php
 *                            -------------------
...
class TsmSeasonsAuthService
{
	...
	public static function check_season_auth()
	{
		$instance = new self();
		return $instance;
	}

	public function read_season()
	{
		return $this->is_authorized(self::READ_SEASON_AUTH);
	}

	public function write_season()
	{
		return $this->is_authorized(self::WRITE_SEASON_AUTH);
	}

	public function contribution_season()
	{
		return $this->is_authorized(self::CONTRIBUTION_SEASON_AUTH);
	}

	public function moderation_season()
	{
	...
	{
		$auth = TsmConfig::load()->get_season_auth();
