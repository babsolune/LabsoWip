<?php
/*##################################################
 *                   TsmAuthorizationsService.class.php
 *                            -------------------
...
class TsmAuthorizationsService
{
	public $id_category;
	...
	{
		$auth = TsmService::get_categories_manager()->get_heritated_authorizations($this->id_category, $bit, $mode);
