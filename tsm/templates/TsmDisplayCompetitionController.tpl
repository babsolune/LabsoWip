	...
	<article itemscope="itemscope" itemtype="http://schema.org/Competition" id="article-tsm-{ID}" class="article-tsm# IF C_NEW_CONTENT # new-content# ENDIF #">
		<header>
			...
			<div class="more">
				...
				&nbsp;<i class="fa fa-eye" title="{VIEWS_NUMBER} {@tsm.sort.field.views}"></i>&nbsp;<span title="{VIEWS_NUMBER} {@tsm.sort.field.views}">{VIEWS_NUMBER}</span>
