...
class ModcatPrintItemController extends ModuleController
{
	...
	private function check_authorizations()
	{
		...
		$not_authorized = !ModcatAuthorizationsService::check_authorizations($itemcat->get_id_category())->write() && (!ModcatAuthorizationsService::check_authorizations($itemcat->get_id_category())->moderation() && $itemcat->get_author_user()->get_id() != AppContext::get_current_user()->get_id());
