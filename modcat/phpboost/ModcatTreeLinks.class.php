...
class ModcatTreeLinks implements ModuleTreeLinksExtensionPoint
{
	public function get_actions_tree_links()
	{
		...
		$manage_categories_link->add_sub_link(new ModuleLink(LangLoader::get_message('category.add', 'categories-common'), ModcatUrlBuilder::add_category(AppContext::get_request()->get_getint('id_category', Category::ROOT_CATEGORY)), ModcatAuthorizationsService::check_authorizations()->manage_categories()));
		...
		$manage_modcat_link->add_sub_link(new ModuleLink($lang['modcat.add'], ModcatUrlBuilder::add_item(AppContext::get_request()->get_getint('id_category', Category::ROOT_CATEGORY)), ModcatAuthorizationsService::check_authorizations()->moderation()));
		...
		{
			$tree->add_link(new ModuleLink($lang['modcat.add'], ModcatUrlBuilder::add_item(AppContext::get_request()->get_getint('id_category', Category::ROOT_CATEGORY)), ModcatAuthorizationsService::check_authorizations()->write() || ModcatAuthorizationsService::check_authorizations()->contribution()));
		}
