...
class SponsorsCategoriesCache extends CategoriesCache
{
	...
	{
		$now = new Date();
		return SponsorsService::count('WHERE id_category = :id_category AND (published = 1 OR (published = 2 AND publication_start_date < :timestamp_now AND (publication_end_date > :timestamp_now OR publication_end_date = 0)))',
			array(
