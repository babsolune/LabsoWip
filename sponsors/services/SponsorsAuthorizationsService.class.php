<?php
/*##################################################
 *		   SponsorsAuthorizationsService.class.php
 *                            -------------------
 *   begin                : May 20, 2018 
...
class SponsorsAuthorizationsService
{
	public $id_category;
	...
	{
		$auth = SponsorsService::get_categories_manager()->get_heritated_authorizations($this->id_category, $bit, $mode);
