<?php
/*##################################################
 *                   AdminSponsorsCategoriesConfigController.class.php
 *                            -------------------
 *   begin                : May 20, 2018
...
class AdminSponsorsMiniMenuConfigController extends AdminModuleController
{
	/**
	 * @var HTMLForm
	 */
	...
	public function execute(HTTPRequestCustom $request)
	{
		...
		return new AdminSponsorsDisplayResponse($tpl, $this->lang['config.mini.title']);
	}
