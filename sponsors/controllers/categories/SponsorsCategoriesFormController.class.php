<?php
/*##################################################
 *                               SponsorsCategoriesFormController.class.php
 *                            -------------------
...
class SponsorsCategoriesFormController extends AbstractRichCategoriesFormController
{
	...
	{
		return SponsorsUrlBuilder::add_category(AppContext::get_request()->get_getint('id_parent', 0));
	}
