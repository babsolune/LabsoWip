...
<li class="formatter-li"> Pour configurer ou personnaliser les conditions générales d\'utilisation, rendez vous dans la <a href="' . SponsorsUrlBuilder::membership_terms_configuration()->relative() . '">configuration des CGU</a></li>
<li class="formatter-li"> Pour créer des catégories, <a href="' . SponsorsUrlBuilder::add_category()->relative() . '">cliquez ici</a> </li>
<li class="formatter-li"> Pour ajouter des annonces, <a href="' . SponsorsUrlBuilder::add_item()->relative() . '">cliquez ici</a></li>
</ul>
