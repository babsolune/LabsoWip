...
class StaffSetup extends DefaultModuleSetup
{
	...
	private function create_staff_table()
	{
		$fields = array(
			...
			'role' => array('type' => 'string', 'length' => 255, 'notnull' => 1, 'default' => "''"),
			'member_phone' => array('type' => 'string', 'length' => 255, 'notnull' => 1, 'default' => "''"),
			'member_email' => array('type' => 'string', 'length' => 255, 'notnull' => 1, 'default' => "''"),
		);
		$options = array(
			'primary' => array('id'),
			'indexes' => array(
