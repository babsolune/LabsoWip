<?php
/*##################################################
 *		      StaffFormFieldSelectUser.class.php
 *                            -------------------
 *   begin                : March 15, 2018
...
class StaffFormFieldSelectUser extends FormFieldAjaxCompleter
{
	...
	{
		$field_options['file'] = TPL_PATH_TO_ROOT . '/staff/ajax/StaffAjaxSelectUser.class.php/?token='. AppContext::get_session()->get_token(); // /?token='. AppContext::get_session()->get_token()
