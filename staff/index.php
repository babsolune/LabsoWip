...
$url_controller_mappers = array(
	...
	new UrlControllerMapper('StaffFormController', '`^/add/?([0-9]+)?/?$`', array('id_category')),
	new UrlControllerMapper('StaffFormController', '`^/([0-9]+)/edit/?$`', array('id')),
	new UrlControllerMapper('StaffDeleteController', '`^/([0-9]+)/delete/?$`', array('id')),
	new UrlControllerMapper('StaffDisplayMemberController', '`^/([0-9]+)-([a-z0-9-_]+)/([0-9]+)-([a-z0-9-_]+)?/?$`', array('id_category', 'rewrited_name_category', 'id', 'rewrited_name')),
