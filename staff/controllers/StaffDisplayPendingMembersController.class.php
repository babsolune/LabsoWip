...
class StaffDisplayPendingMembersController extends ModuleController
{
	...
	public function init()
	{
		...
		$this->tpl = new FileTemplate('staff/StaffDisplaySeveralMembersController.tpl');
	...
	private function generate_response()
	{
		...
		$graphical_environment->set_page_title($this->lang['staff.pending'], $this->lang['module_title']);
