...
class StaffFormController extends ModuleController
{
	/**
	 * @var HTMLForm
	 */
	...
	private function build_form(HTTPRequestCustom $request)
	{
		...
		$fieldset->add_field(new FormFieldTextEditor('role', $this->lang['staff.form.role'], $this->get_member()->get_role()));
	...
	private function save()
	{
        ...
        $member->set_role((string)$this->form->get_value('role'));
	...
	private function generate_response(View $tpl)
	{
		...
		if ($member->get_id() === null)
		{
			...
			$graphical_environment->get_seo_meta_data()->set_description($this->lang['staff.add'], $this->lang['module_title']);
		...
		else
		{
			...
			$graphical_environment->get_seo_meta_data()->set_description($this->lang['staff.edit'], $this->lang['module_title']);
