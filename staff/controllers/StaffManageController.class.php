...
class StaffManageController extends AdminModuleController
{
	...
	private function build_table()
	{
		...
		foreach ($result as $row)
		{
			...
			$row = array(
				new HTMLTableRowCell(new LinkHTMLElement(StaffUrlBuilder::display($category->get_id(), $category->get_rewrited_name(), $member->get_id(), $member->get_rewrited_name()), $member->get_lastname() . ' ' . $member->get_firstname()), 'left'),
	...
	private function generate_response()
	{
		...
		$graphical_environment->set_page_title($this->lang['staff.management'], $this->lang['module_title']);
