...
class ModmixPrintItemController extends ModuleController
{
	...
	private function check_authorizations()
	{
		...
		$not_authorized = !ModmixAuthorizationsService::check_authorizations($itemmix->get_id_category())->write() && (!ModmixAuthorizationsService::check_authorizations($itemmix->get_id_category())->moderation() && $itemmix->get_author_user()->get_id() != AppContext::get_current_user()->get_id());
