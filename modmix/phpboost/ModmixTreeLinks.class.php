...
class ModmixTreeLinks implements ModuleTreeLinksExtensionPoint
{
	public function get_actions_tree_links()
	{
		...
		$manage_categories_link->add_sub_link(new ModuleLink(LangLoader::get_message('category.add', 'categories-common'), ModmixUrlBuilder::add_category(AppContext::get_request()->get_getint('id_category', Category::ROOT_CATEGORY)), ModmixAuthorizationsService::check_authorizations()->manage_categories()));
		...
		$manage_modmix_link->add_sub_link(new ModuleLink($lang['modmix.add'], ModmixUrlBuilder::add_item(AppContext::get_request()->get_getint('id_category', Category::ROOT_CATEGORY)), ModmixAuthorizationsService::check_authorizations()->moderation()));
		...
		{
			$tree->add_link(new ModuleLink($lang['modmix.add'], ModmixUrlBuilder::add_item(AppContext::get_request()->get_getint('id_category', Category::ROOT_CATEGORY)), ModmixAuthorizationsService::check_authorizations()->write() || ModmixAuthorizationsService::check_authorizations()->contribution()));
		}
