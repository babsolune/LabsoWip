...
class ModcatartPrintItemController extends ModuleController
{
	...
	private function check_authorizations()
	{
		...
		$not_authorized = !ModcatartAuthorizationsService::check_authorizations($itemcatart->get_id_category())->write() && (!ModcatartAuthorizationsService::check_authorizations($itemcatart->get_id_category())->moderation() && $itemcatart->get_author_user()->get_id() != AppContext::get_current_user()->get_id());
