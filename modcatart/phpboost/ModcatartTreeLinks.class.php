...
class ModcatartTreeLinks implements ModuleTreeLinksExtensionPoint
{
	public function get_actions_tree_links()
	{
		...
		$manage_categories_link->add_sub_link(new ModuleLink(LangLoader::get_message('category.add', 'categories-common'), ModcatartUrlBuilder::add_category(AppContext::get_request()->get_getint('id_category', Category::ROOT_CATEGORY)), ModcatartAuthorizationsService::check_authorizations()->manage_categories()));
		...
		$manage_modcatart_link->add_sub_link(new ModuleLink($lang['modcatart.add'], ModcatartUrlBuilder::add_item(AppContext::get_request()->get_getint('id_category', Category::ROOT_CATEGORY)), ModcatartAuthorizationsService::check_authorizations()->moderation()));
		...
		{
			$tree->add_link(new ModuleLink($lang['modcatart.add'], ModcatartUrlBuilder::add_item(AppContext::get_request()->get_getint('id_category', Category::ROOT_CATEGORY)), ModcatartAuthorizationsService::check_authorizations()->write() || ModcatartAuthorizationsService::check_authorizations()->contribution()));
		}
