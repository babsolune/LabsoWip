...
$url_controller_mappers = array(
	...
	new UrlControllerMapper('ModcatartItemFormController', '`^/add/?([0-9]+)?/?$`', array('id_category')),
	...
	new UrlControllerMapper('ModcatartDisplayItemController', '`^(?:/([0-9]+)-([a-z0-9-_]+)/([0-9]+)-([a-z0-9-_]+))/?([0-9]+)?/?$`', array('id_category', 'rewrited_name_category', 'id', 'rewrited_title', 'page')),
	...
	new UrlControllerMapper('ModcatartDisplayCategoryController', '`^(?:/([0-9]+)-([a-z0-9-_]+))?/?([a-z]+)?/?([a-z]+)?/?([0-9]+)?/?([0-9]+)?/?$`', array('id_category', 'rewrited_name', 'field', 'sort', 'page', 'subcategories_page'))
);
