...
# Tooltip
Afin de supprimer les title="" qui limitent les performences en mobile, un système de tooltip est mis en place sur les aria-label, ce qui permet l'affichage des textes cachés, au survole de lasouris en profitant des attributs d'accessibilité  
