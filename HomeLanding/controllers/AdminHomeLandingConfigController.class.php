...
class AdminHomeLandingConfigController extends AdminModuleController
{
	...
	private function init()
	{
		...
		$this->tpl = new FileTemplate('HomeLanding/AdminHomeLandingConfigController.tpl');
	...
	public function execute(HTTPRequestCustom $request)
	{
		...
		if ($this->submit_button->has_been_submited() && $this->form->validate())
		{
			...
			$this->carousel_f->get_field_by_id('carousel')->set_hidden(!$this->modules[HomeLandingConfig::MODULE_CAROUSEL]->is_displayed());
			$this->carousel_f->get_field_by_id('carousel_speed')->set_hidden(!$this->modules[HomeLandingConfig::MODULE_CAROUSEL]->is_displayed());
			$this->carousel_f->get_field_by_id('carousel_time')->set_hidden(!$this->modules[HomeLandingConfig::MODULE_CAROUSEL]->is_displayed());
			$this->carousel_f->get_field_by_id('carousel_nav')->set_hidden(!$this->modules[HomeLandingConfig::MODULE_CAROUSEL]->is_displayed());
			$this->carousel_f->get_field_by_id('carousel_hover')->set_hidden(!$this->modules[HomeLandingConfig::MODULE_CAROUSEL]->is_displayed());
			$this->carousel_f->get_field_by_id('carousel_mini')->set_hidden(!$this->modules[HomeLandingConfig::MODULE_CAROUSEL]->is_displayed());

			$this->config_f->get_field_by_id('edito')->set_hidden(!$this->modules[HomeLandingConfig::MODULE_EDITO]->is_displayed());

			$this->config_f->get_field_by_id('lastcoms_limit')->set_hidden(!$this->modules[HomeLandingConfig::MODULE_LASTCOMS]->is_displayed());
			$this->config_f->get_field_by_id('lastcoms_char')->set_hidden(!$this->modules[HomeLandingConfig::MODULE_LASTCOMS]->is_displayed());

			if (ModulesManager::is_module_installed('articles') & ModulesManager::is_module_activated('articles'))
			{
				$this->articles_f->get_field_by_id('articles_limit')->set_hidden(!$this->modules[HomeLandingConfig::MODULE_ARTICLES]->is_displayed());
				$this->articles_f->get_field_by_id('articles_cat')->set_hidden(!$this->modules[HomeLandingConfig::MODULE_ARTICLES_CATEGORY]->is_displayed());
				$this->articles_f->get_field_by_id('articles_subcategories_content_displayed')->set_hidden(!$this->modules[HomeLandingConfig::MODULE_ARTICLES_CATEGORY]->is_displayed());
				$this->articles_f->get_field_by_id('articles_cat_limit')->set_hidden(!$this->modules[HomeLandingConfig::MODULE_ARTICLES_CATEGORY]->is_displayed());
				$this->articles_f->get_field_by_id('articles_cat_char')->set_hidden(!$this->modules[HomeLandingConfig::MODULE_ARTICLES_CATEGORY]->is_displayed());
			}

			if (ModulesManager::is_module_installed('calendar') & ModulesManager::is_module_activated('calendar'))
			{
				$this->calendar_f->get_field_by_id('calendar_limit')->set_hidden(!$this->modules[HomeLandingConfig::MODULE_CALENDAR]->is_displayed());
				$this->calendar_f->get_field_by_id('calendar_char')->set_hidden(!$this->modules[HomeLandingConfig::MODULE_CALENDAR]->is_displayed());
			}

			if (ModulesManager::is_module_installed('download') & ModulesManager::is_module_activated('download'))
			{
				$this->download_f->get_field_by_id('download_limit')->set_hidden(!$this->modules[HomeLandingConfig::MODULE_DOWNLOAD]->is_displayed());
				$this->download_f->get_field_by_id('download_cat')->set_hidden(!$this->modules[HomeLandingConfig::MODULE_DOWNLOAD_CATEGORY]->is_displayed());
				$this->download_f->get_field_by_id('download_subcategories_content_displayed')->set_hidden(!$this->modules[HomeLandingConfig::MODULE_DOWNLOAD_CATEGORY]->is_displayed());
				$this->download_f->get_field_by_id('download_cat_limit')->set_hidden(!$this->modules[HomeLandingConfig::MODULE_DOWNLOAD_CATEGORY]->is_displayed());
				$this->download_f->get_field_by_id('download_cat_char')->set_hidden(!$this->modules[HomeLandingConfig::MODULE_DOWNLOAD_CATEGORY]->is_displayed());
			}

			if (ModulesManager::is_module_installed('forum') & ModulesManager::is_module_activated('forum'))
			{
				$this->forum_f->get_field_by_id('forum_limit')->set_hidden(!$this->modules[HomeLandingConfig::MODULE_FORUM]->is_displayed());
				$this->forum_f->get_field_by_id('forum_char')->set_hidden(!$this->modules[HomeLandingConfig::MODULE_FORUM]->is_displayed());
			}

			if (ModulesManager::is_module_installed('gallery') & ModulesManager::is_module_activated('gallery'))
			{
				$this->gallery_f->get_field_by_id('gallery_limit')->set_hidden(!$this->modules[HomeLandingConfig::MODULE_GALLERY]->is_displayed());
			}

			if (ModulesManager::is_module_installed('guestbook') & ModulesManager::is_module_activated('guestbook'))
			{
				$this->guestbook_f->get_field_by_id('guestbook_limit')->set_hidden(!$this->modules[HomeLandingConfig::MODULE_GUESTBOOK]->is_displayed());
				$this->guestbook_f->get_field_by_id('guestbook_char')->set_hidden(!$this->modules[HomeLandingConfig::MODULE_GUESTBOOK]->is_displayed());
			}

			if (ModulesManager::is_module_installed('media') & ModulesManager::is_module_activated('media'))
			{
				$this->media_f->get_field_by_id('media_limit')->set_hidden(!$this->modules[HomeLandingConfig::MODULE_MEDIA]->is_displayed());
			}

			if (ModulesManager::is_module_installed('news') & ModulesManager::is_module_activated('news'))
			{
				$this->news_f->get_field_by_id('news_limit')->set_hidden(!$this->modules[HomeLandingConfig::MODULE_NEWS]->is_displayed());
				$this->news_f->get_field_by_id('news_cat')->set_hidden(!$this->modules[HomeLandingConfig::MODULE_NEWS_CATEGORY]->is_displayed());
				$this->news_f->get_field_by_id('news_subcategories_content_displayed')->set_hidden(!$this->modules[HomeLandingConfig::MODULE_NEWS_CATEGORY]->is_displayed());
				$this->news_f->get_field_by_id('news_cat_limit')->set_hidden(!$this->modules[HomeLandingConfig::MODULE_NEWS_CATEGORY]->is_displayed());
				$this->news_f->get_field_by_id('news_cat_char')->set_hidden(!$this->modules[HomeLandingConfig::MODULE_NEWS_CATEGORY]->is_displayed());
			}
			...
			{
				$this->web_f->get_field_by_id('web_limit')->set_hidden(!$this->modules[HomeLandingConfig::MODULE_WEB]->is_displayed());
				$this->web_f->get_field_by_id('web_cat')->set_hidden(!$this->modules[HomeLandingConfig::MODULE_WEB_CATEGORY]->is_displayed());
				$this->web_f->get_field_by_id('web_subcategories_content_displayed')->set_hidden(!$this->modules[HomeLandingConfig::MODULE_WEB_CATEGORY]->is_displayed());
				$this->web_f->get_field_by_id('web_cat_limit')->set_hidden(!$this->modules[HomeLandingConfig::MODULE_WEB_CATEGORY]->is_displayed());
				$this->web_f->get_field_by_id('web_cat_char')->set_hidden(!$this->modules[HomeLandingConfig::MODULE_WEB_CATEGORY]->is_displayed());
			}

			$this->tpl->put('MSG', MessageHelper::display(LangLoader::get_message('message.success.config', 'status-messages-common'), MessageHelper::SUCCESS, 4));
		}

		// $this->tpl->put('FORM', $this->form->display());

		$this->tpl->put_all(array(
			'C_ARTICLES' => ModulesManager::is_module_installed('articles') && ModulesManager::is_module_activated('articles'),
			'C_CALENDAR' => ModulesManager::is_module_installed('calendar') && ModulesManager::is_module_activated('calendar'),
			'C_CONTACT' => ModulesManager::is_module_installed('contact') && ModulesManager::is_module_activated('contact'),
			'C_DOWNLOAD' => ModulesManager::is_module_installed('download') && ModulesManager::is_module_activated('download'),
			'C_FORUM' => ModulesManager::is_module_installed('forum') && ModulesManager::is_module_activated('forum'),
			'C_GALLERY' => ModulesManager::is_module_installed('gallery') && ModulesManager::is_module_activated('gallery'),
			'C_GUESTBOOK' => ModulesManager::is_module_installed('guestbook') && ModulesManager::is_module_activated('guestbook'),
			'C_MEDIA' => ModulesManager::is_module_installed('media') && ModulesManager::is_module_activated('media'),
			'C_NEWS' => ModulesManager::is_module_installed('news') && ModulesManager::is_module_activated('news'),
			'C_WEB' => ModulesManager::is_module_installed('web') && ModulesManager::is_module_activated('web'),
		));

		return new AdminHomeLandingDisplayResponse($this->tpl, LangLoader::get_message('configuration', 'admin-common'));
	}
	...
	private function build_form()
	{
		...
		$this->build_config_form($form);
		$this->build_slider_form($form);
		$this->build_articles_form($form);
		$this->build_calendar_form($form);
		$this->build_contact_form($form);
		$this->build_download_form($form);
		$this->build_forum_form($form);
		$this->build_gallery_form($form);
		$this->build_guestbook_form($form);
		$this->build_media_form($form);
		$this->build_news_form($form);
		$this->build_rss_form($form);
		$this->build_web_form($form);
		$this->build_submit_form($form);

		$this->form = $form;
	}

	private function build_config_form($form)
	{
		//Configuration
		...
		$fieldset_config->add_field(new FormFieldTextEditor('module_title', $this->lang['admin.module.title'], $this->config->get_module_title(),
			array('class' => 'third-field', 'description' => $this->lang['admin.module.title.desc'])
		));
		...
		$fieldset_config->add_field(new FormFieldRichTextEditor('edito', $this->lang['admin.edito.content'], $this->config->get_edito(),
			array('class' => 'third-field', 'hidden' => !$this->modules[HomeLandingConfig::MODULE_EDITO]->is_displayed())
		));
		...
		$fieldset_config->add_field(new FormFieldNumberEditor('lastcoms_limit', $this->lang['admin.lastcoms.limit'], $this->modules[HomeLandingConfig::MODULE_LASTCOMS]->get_elements_number_displayed(),
			array('class' => 'third-field', 'min' => 1, 'max' => 100, 'hidden' => !$this->modules[HomeLandingConfig::MODULE_LASTCOMS]->is_displayed()),
		...
		$this->config_f = $fieldset_config;
		$this->tpl->put('CONFIG_FORM', $this->config_f->display());

	}

	private function build_slider_form($form)
	{
		...
		$fieldset_carousel->add_field(new FormFieldSimpleSelectChoice('carousel_hover', $this->lang['admin.form.carousel.hover'], $this->config->get_carousel_hover(),
			...
			array('class' => 'top-field', 'hidden' => !$this->modules[HomeLandingConfig::MODULE_CAROUSEL]->is_displayed())
		));
		...
		$fieldset_carousel->add_field(new HomeLandingFormFieldSliderConfig('carousel', $this->lang['admin.form.carousel'], $this->config->get_carousel(),
			array('class' => 'half-field', 'hidden' => !$this->modules[HomeLandingConfig::MODULE_CAROUSEL]->is_displayed())
		));

		$this->carousel_f = $fieldset_carousel;
		$this->tpl->put('CAROUSEL_FORM', $this->carousel_f->display());
	}

	private function build_articles_form($form)
	{
		if (ModulesManager::is_module_installed('articles') & ModulesManager::is_module_activated('articles'))
		{
		...
		$this->articles_f = $fieldset_articles;
		$this->tpl->put('ARTICLES_FORM', $this->articles_f->display());

	}

	private function build_calendar_form($form)
	{
		if (ModulesManager::is_module_installed('calendar') & ModulesManager::is_module_activated('calendar'))
		{
		...
		$this->calendar_f = $fieldset_calendar;
		$this->tpl->put('CALENDAR_FORM', $this->calendar_f->display());
	}

	private function build_contact_form($form)
	{
		...
		$this->contact_f = $fieldset_contact;
		$this->tpl->put('CONTACT_FORM', $this->contact_f->display());
	}

	private function build_download_form($form)
	{
		if (ModulesManager::is_module_installed('download') & ModulesManager::is_module_activated('download'))
		{
		...
		$this->download_f = $fieldset_download;
		$this->tpl->put('DOWNLOAD_FORM', $this->download_f->display());
	}

	private function build_forum_form($form)
	{
		if (ModulesManager::is_module_installed('forum') & ModulesManager::is_module_activated('forum'))
		{
		...
		$this->forum_f = $fieldset_forum;
		$this->tpl->put('FORUM_FORM', $this->forum_f->display());
	}

	private function build_gallery_form($form)
	{
		if (ModulesManager::is_module_installed('gallery') & ModulesManager::is_module_activated('gallery'))
		{
		...
		$this->gallery_f = $fieldset_gallery;
		$this->tpl->put('GALLERY_FORM', $this->gallery_f->display());
	}

	private function build_guestbook_form($form)
	{
		if (ModulesManager::is_module_installed('guestbook') & ModulesManager::is_module_activated('guestbook'))
		{
		...
		$this->guestbook_f = $fieldset_guestbook;
		$this->tpl->put('GUESTBOOK_FORM', $this->guestbook_f->display());
	}

	private function build_media_form($form)
	{
		if (ModulesManager::is_module_installed('media') & ModulesManager::is_module_activated('media'))
		{
		...
		$this->media_f = $fieldset_media;
		$this->tpl->put('MEDIA_FORM', $this->media_f->display());
	}

	private function build_news_form($form)
	{
		if (ModulesManager::is_module_installed('news') & ModulesManager::is_module_activated('news'))
		{
		...
		$this->news_f = $fieldset_news;
		$this->tpl->put('NEWS_FORM', $this->news_f->display());
	}

	private function build_rss_form($form)
	{
		...
		// ));
		//
		// $this->rss_f = $fieldset_rss;
		// $this->tpl->put('RSS_FORM', $this->rss_f->display());
	}

	private function build_web_form($form)
	{
		if (ModulesManager::is_module_installed('web') & ModulesManager::is_module_activated('web'))
		{
		...
		$this->web_f = $fieldset_web;
		$this->tpl->put('WEB_FORM', $this->web_f->display());
	}

	private function build_submit_form($form)
	{
		$this->submit_button = new FormButtonDefaultSubmit();
		$form->add_button($this->submit_button);
		$form->add_button(new FormButtonReset());

		$this->tpl->put('SUBMIT_FORM', $this->submit_button->display());
	}
