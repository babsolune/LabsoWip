...
class HomeLandingHomeController extends ModuleController
{
	...
	private function build_lastcoms_view()
	{
		...
		$result = $this->querier->select('SELECT c.id, c.user_id, c.pseudo, c.message, c.timestamp, ct.path, ct.module_id, ct.is_locked, m.level
			...
			array(
				'lastcoms_number' => (int)$this->modules[HomeLandingConfig::MODULE_LASTCOMS]->get_elements_number_displayed(),
