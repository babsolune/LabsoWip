...
class ModcatfullPrintItemController extends ModuleController
{
	...
	private function check_authorizations()
	{
		...
		$not_authorized = !ModcatfullAuthorizationsService::check_authorizations($itemcatfull->get_id_category())->write() && (!ModcatfullAuthorizationsService::check_authorizations($itemcatfull->get_id_category())->moderation() && $itemcatfull->get_author_user()->get_id() != AppContext::get_current_user()->get_id());
