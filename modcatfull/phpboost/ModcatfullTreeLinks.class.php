...
class ModcatfullTreeLinks implements ModuleTreeLinksExtensionPoint
{
	public function get_actions_tree_links()
	{
		...
		$manage_categories_link->add_sub_link(new ModuleLink(LangLoader::get_message('category.add', 'categories-common'), ModcatfullUrlBuilder::add_category(AppContext::get_request()->get_getint('id_category', Category::ROOT_CATEGORY)), ModcatfullAuthorizationsService::check_authorizations()->manage_categories()));
		...
		$manage_modcatfull_link->add_sub_link(new ModuleLink($lang['modcatfull.add'], ModcatfullUrlBuilder::add_item(AppContext::get_request()->get_getint('id_category', Category::ROOT_CATEGORY)), ModcatfullAuthorizationsService::check_authorizations()->moderation()));
		...
		{
			$tree->add_link(new ModuleLink($lang['modcatfull.add'], ModcatfullUrlBuilder::add_item(AppContext::get_request()->get_getint('id_category', Category::ROOT_CATEGORY)), ModcatfullAuthorizationsService::check_authorizations()->write() || ModcatfullAuthorizationsService::check_authorizations()->contribution()));
		}
