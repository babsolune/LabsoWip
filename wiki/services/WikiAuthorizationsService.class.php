<?php
/*##################################################
 *		   WikiAuthorizationsService.class.php
 *                            -------------------
 *   begin                : May 25, 2018
...
class WikiAuthorizationsService
{
	public $id_category;
	...
	{
		$auth = WikiService::get_categories_manager()->get_heritated_authorizations($this->id_category, $bit, $mode);
