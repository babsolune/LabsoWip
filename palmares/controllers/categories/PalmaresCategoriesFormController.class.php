<?php
/*##################################################
 *		                PalmaresCategoriesFormController.class.php
 *                            -------------------
 ...
 */
class PalmaresCategoriesFormController extends AbstractRichCategoriesFormController
{
	...
	{
		return PalmaresUrlBuilder::add_category(AppContext::get_request()->get_getint('id_parent', 0));
	}
