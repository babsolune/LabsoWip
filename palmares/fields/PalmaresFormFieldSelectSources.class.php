<?php
/*##################################################
 *		               PalmaresFormFieldSelectSources.class.php
 *                            -------------------
 ...
 */
class PalmaresFormFieldSelectSources extends AbstractFormField
{
	...
	function display()
	{
		...
		$tpl = new FileTemplate('palmares/PalmaresFormFieldSelectSources.tpl');
