<?php
/*##################################################
 *		                PalmaresAuthorizationsService.class.php
 *                            -------------------
 *   begin                : April 13, 2016
...
class PalmaresAuthorizationsService
{
	public $id_category;
	...
	{
		$auth = PalmaresService::get_categories_manager()->get_heritated_authorizations($this->id_category, $bit, $mode);
