<?php
/*##################################################
 *                               ClubsAuthorizationsService.class.php
 *                            -------------------
 *   begin                : June 23, 2017
...
class ClubsAuthorizationsService
{
	public $id_category;
	...
	{
		$auth = ClubsService::get_categories_manager()->get_heritated_authorizations($this->id_category, $bit, $mode);
