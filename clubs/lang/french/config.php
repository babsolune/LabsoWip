...
$lang['root_category_description'] = 'Bienvenue dans l\'espace consacré aux liens clubs du site !
<br /><br />
...
<ul class="formatter-ul">
	...
	<li class="formatter-li"> Pour créer des catégories, <a href="' . ClubsUrlBuilder::add_category()->relative() . '">cliquez ici</a> </li>
