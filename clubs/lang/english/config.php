...
$lang['root_category_description'] = 'Welcome to the clubs links section of the clubssite!
<br /><br />
...
<ul class="formatter-ul">
	...
	<li class="formatter-li"> To create categories, <a href="' . ClubsUrlBuilder::add_category()->relative() . '">clic here</a></li>
