<?php
/*##################################################
 *                               ClubsCategoriesFormController.class.php
 *                            -------------------
 *   begin                : June 23, 2017
...
class ClubsCategoriesFormController extends AbstractRichCategoriesFormController
{
	...
	{
		return ClubsUrlBuilder::add_category(AppContext::get_request()->get_getint('id_parent', 0));
	}
