<section id="module-pbtdoc">
	<header>
		<h1>
			...
			{@courses}# IF NOT C_ROOT_CATEGORY # - {CATEGORY_NAME}# ENDIF # # IF IS_ADMIN #<a href="{U_EDIT_CATEGORY}" title="${LangLoader::get_message('edit', 'common')}"><i class="fa fa-edit small"></i></a># ENDIF #
		</h1>
	</header>
	<div class="elements-container">
		# INCLUDE NOT_VISIBLE_MESSAGE #
		<article itemscope="itemscope" itemtype="http://schema.org/Course" id="course-pbtdoc-{ID}" class="course-pbtdoc# IF C_NEW_CONTENT # new-content# ENDIF #">
			<header>
				<h2>
					<span itemprop="name">{TITLE}</span>
					<span class="actions">
						# IF C_EDIT #
							<a href="{U_EDIT_COURSE}" title="${LangLoader::get_message('edit', 'common')}"><i class="fa fa-edit"></i></a>
						# ENDIF #
						# IF C_DELETE #
							<a href="{U_DELETE_COURSE}" title="${LangLoader::get_message('delete', 'common')}" data-confirmation="delete-element"><i class="fa fa-delete"></i></a>
						# ENDIF #
							<a href="{U_PRINT_COURSE}" title="${LangLoader::get_message('printable_version', 'main')}" target="blank"><i class="fa fa-print"></i></a>
					</span>
				</h2>
				...
				<div class="more">
					...
					# ENDIF #
					&nbsp;<i class="fa fa-eye" title="{NUMBER_VIEW} {@pbtdoc.views.nb}"></i>&nbsp;<span title="{NUMBER_VIEW} {@pbtdoc.views.nb}">{NUMBER_VIEW}</span>
				</div>

				<meta itemprop="url" content="{U_COURSE}">
			...
			<div class="content">
				...
				# IF C_PAGINATION #
					...
					<div class="pages-pagination center"># INCLUDE PAGINATION_COURSES #</div>
