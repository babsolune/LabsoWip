...
<!--
	...
	{
		var page = prompt('{@pbtdoc.form.add_page.title}', '');

		if (page) {
			# IF C_TINYMCE_EDITOR #
			tinymce.activeEditor.execCommand('mceInsertContent', false, '[page]' + page + '[/page]');
			# ELSE #
			var textarea = document.getElementById('PbtdocFormController_contents');
	...
	{
		var searchText = page;
		var content_input = document.getElementById('PbtdocFormController_contents');
