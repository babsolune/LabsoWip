<?php
/*##################################################
 *		   PbtdocAuthorizationsService.class.php
 *                            -------------------
 ...
 */
class PbtdocAuthorizationsService
{
	public $id_category;
	...
	{
		$auth = PbtdocService::get_categories_manager()->get_heritated_authorizations($this->id_category, $bit, $mode);
