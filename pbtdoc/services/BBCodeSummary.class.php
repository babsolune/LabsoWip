...
class BBCodeSummary
{
    // Independance du module utilisé
function get_current_module()
{}
    //Parsing en ajoutant la balise [link]
function content_parse($contents)
{
...
function content_unparse($contents)
{
	$content_manager = AppContext::get_content_formatting_service()->get_default_factory();
...
function content_second_parse($contents)
{
	$content_manager = AppContext::get_content_formatting_service()->get_default_factory();
	$second_parser = $content_manager->get_second_parser();
	$second_parser->set_content(content_unparse($contents));
	$second_parser->parse();
