 ...
 */
class PbtdocUrlBuilder
{
	private static $dispatcher = '/pbtdoc';
	...
	{
		return SyndicationUrlBuilder::rss('pbtdoc', $id);
	}
	...
	public static function print_item($id_course, $rewrited_title)
	{
		return DispatchManager::get_url(self::$dispatcher, '/print/' . $id_course . '-' .$rewrited_title . '/');
	}
	...
	public static function display_item($id_category, $rewrited_name_category, $id_course, $rewrited_title, $page = 1)
	{
		$page = $page !== 1 ? $page . '/' : '';
		return DispatchManager::get_url(self::$dispatcher, '/' . $id_category . '-' . $rewrited_name_category . '/' . $id_course . '-' .$rewrited_title . '/' . $page);
	}
