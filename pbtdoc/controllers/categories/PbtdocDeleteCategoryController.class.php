<?php
/*##################################################
 *		      PbtdocDeleteCategoryController.class.php
 *                            -------------------
 *   begin                : March 04, 2013
...
class PbtdocDeleteCategoryController extends AbstractDeleteCategoryController
{
	...
	{
		return LangLoader::get_message('pbtdoc', 'common', 'pbtdoc');
	}
