<?php
/*##################################################
 *		   PbtdocCategoriesFormController.class.php
 *                            -------------------
 *   begin                : March 04, 2013
...
class PbtdocCategoriesFormController extends AbstractRichCategoriesFormController
{
	...
	{
		return PbtdocUrlBuilder::add_category(AppContext::get_request()->get_getint('id_parent', 0));
	}
