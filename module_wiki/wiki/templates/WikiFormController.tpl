...
<!--
	...
	{
		var page = prompt('{@wiki.form.add_page.title}', '');

		if (page) {
			# IF C_TINYMCE_EDITOR #
			tinymce.activeEditor.execCommand('mceInsertContent', false, '[page]' + page + '[/page]');
			# ELSE #
			var textarea = document.getElementById('WikiFormController_contents');
	...
	{
		var searchText = page;
		var content_input = document.getElementById('WikiFormController_contents');
