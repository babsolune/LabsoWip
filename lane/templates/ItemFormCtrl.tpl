...
<!--
	...
	{
		var page = prompt('{@form.page.title}', '');

		if (page) {
			# IF C_TINYMCE_EDITOR #
			tinymce.activeEditor.execCommand('mceInsertContent', false, '[page]' + page + '[/page]');
			# ELSE #
			var textarea = document.getElementById('ItemFormCtrl_contents');
	...
	{
		var searchText = page;
		var content_input = document.getElementById('ItemFormCtrl_contents');
