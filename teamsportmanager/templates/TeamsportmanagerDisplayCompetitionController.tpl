<section id="module-teamsportmanager">
	<header>
		<h1>
			<a href="{U_SYNDICATION}" title="${LangLoader::get_message('syndication', 'common')}"><i class="fa fa-syndication"></i></a>
			{@teamsportmanager.module.title}# IF NOT C_ROOT_CATEGORY # - {CATEGORY_NAME}# ENDIF # # IF IS_ADMIN #<a href="{U_EDIT_CATEGORY}" title="${LangLoader::get_message('edit', 'common')}"><i class="fa fa-edit smaller"></i></a># ENDIF #
		</h1>
	</header>
	# INCLUDE NOT_VISIBLE_MESSAGE #
	<article itemscope="itemscope" itemtype="http://schema.org/Competition" id="article-teamsportmanager-{ID}" class="article-teamsportmanager# IF C_NEW_CONTENT # new-content# ENDIF #">
		<header>
			<h2>
			...
			<div class="more">
				...
				&nbsp;<i class="fa fa-eye" title="{VIEWS_NUMBER} {@teamsportmanager.sort.field.views}"></i>&nbsp;<span title="{VIEWS_NUMBER} {@teamsportmanager.sort.field.views}">{VIEWS_NUMBER}</span>
		...
		<aside>
			# IF C_SOURCES #
				<hr />
				<div id="teamsportmanager-sources-container">
