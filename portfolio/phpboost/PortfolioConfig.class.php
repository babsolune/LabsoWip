...
class PortfolioConfig extends AbstractConfigData
{
	...
	public function get_default_values()
	{
		return array(
			...
			self::ROOT_CATEGORY_DESCRIPTION => LangLoader::get_message('root_category_description', 'config', 'portfolio'),
	...
	{
		return ConfigManager::load(__CLASS__, 'portfolio', 'config');
	}
	...
	{
		ConfigManager::save('portfolio', self::load(), 'config');
	}
}
?>
