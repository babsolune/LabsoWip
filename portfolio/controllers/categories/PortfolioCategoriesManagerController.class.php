<?php
/*##################################################
 *		        PortfolioCategoriesManagerController.class.php
 *                            -------------------
...
class PortfolioCategoriesManagerController extends AbstractCategoriesManageController
{
	...
	{
		return PortfolioUrlBuilder::display_category($category->get_id(), $category->get_rewrited_name());
	}
	...
	{
		return PortfolioUrlBuilder::delete_category($category->get_id());
	}
