<?php
/*##################################################
 *		   PortfolioAuthorizationsService.class.php
 *                            -------------------
...
class PortfolioAuthorizationsService
{
	public $category_id;
	...
	{
		$auth = PortfolioService::get_categories_manager()->get_heritated_authorizations($this->category_id, $bit, $mode);
