<?php
/*##################################################
 *		      PortfolioFormFieldSelectSources.class.php
 *                            -------------------
...
class PortfolioFormFieldSelectSources extends AbstractFormField
{
	...
	function display()
	{
		...
		$tpl = new FileTemplate('portfolio/fields/PortfolioFormFieldSelectSources.tpl');
