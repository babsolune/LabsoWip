<?php
/*##################################################
 *		      PortfolioFormFieldCarousel.class.php
 *                            -------------------
...
class PortfolioFormFieldCarousel extends AbstractFormField
{
	...
	function display()
	{
		...
		$tpl = new FileTemplate('portfolio/fields/PortfolioFormFieldCarousel.tpl');
		$tpl->add_lang(LangLoader::get('common'));
		$tpl->add_lang(LangLoader::get('common', 'portfolio'));
